...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private String[] nama,alamat,deskripsi,gambar,id;
    int jumData;
    ...
    private void getlokasi(){
        String url= "https://worshipplace.000webhostapp.com/koneksi.php";
                                ...
                                for (int i=0; i<jumData;i++){
                                    if (marker.getTitle().equals(nama[i])){
                                        if (MarkerD[i]){
                                            ...
                                            TextView textView = pesan.getView().findViewById(R.id.message);
                                            if (textView!=null)
